...
#pragma comment(lib, "winspool.lib")  // ✅ ДОБАВИТЬ для линковки
...
public:
    ReceiptPrinter() : m_initialized(false) {
        ...
        DWORD size = 0;
        EnumPrinters(PRINTER_ENUM_LOCAL, nullptr, 2, nullptr, 0, &size, nullptr);
...
private:
    std::wstring formatTicket(const QueueTicket& ticket,
        ...
        ss << L"Тип очереди: ";
        switch (ticket.type) {
        case QueueType::GENERAL: ss << L"Общая\n"; break;
        case QueueType::FIRST_TIME: ss << L"Первый раз\n"; break;
        case QueueType::EXTRA_20: ss << L"+20 позиций\n"; break;
        case QueueType::TRUST: ss << L"На доверии\n"; break;
        case QueueType::PAID: ss << L"Платный прием\n"; break;
        case QueueType::EXPENSIVE: ss << L"Дорогой товар\n"; break;
        }
